        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center">
            <div className="flex items-center justify-center gap-2.5">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-6xl font-black tracking-tight text-[#F8F5EF] flex items-center gap-2">
                <span>Kirana</span><span className="text-[#B85C38]">Connect</span>
                <span className="px-2.5 py-0.5 text-[15px] font-extrabold uppercase tracking-wider bg-[#B85C38]/20 text-[#D8C3A5] border border-[#D8C3A5]/40 rounded-full shadow-xs">
                  PUDO 2.0
                </span>
              </h1>
            </div>
            <p className="text-xs sm:text-sm font-medium text-[#D8C3A5] mt-1 max-w-xl">
              {language === 'hi'
                ...
                : "India's HyperLocal PUDO & Logistics Network • Failed-Delivery Smart Recovery Hub"}
            </p>
          </div>
